...
def get_borrowed_books_count():
    borrowed_books = []
    with open("day29_book_data.json", "r") as data_file:
...
def borrow_book():
    with open("day29_book_id.txt", "r") as id_file:
    ...
    try:
        ...
        with open("day29_book_data.json", "r") as data_file:
            ...
            if borrowed_books_count < BORROW_BOOKS_LIMIT:
                ...
                with open("day29_book_data.json", "w") as data_file:
                    json.dump(data, data_file, indent=4)

                with open("day29_book_id.txt", "w") as id_file:
